...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 添加路由
    </div>
    <!--面包屑导航 结束-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/addroute')}}"><i class="fa fa-list-ul"></i>路由列表</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/addroute')}}" method="post">
            <table class="add_tab">
                <tbody>
                {{csrf_field()}}
                    {{--<tr>--}}
