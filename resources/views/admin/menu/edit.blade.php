        ...
        <form method="post" action="{{url('admin/menu/'.$info->id)}}">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="fid">
                            ...
                            @foreach($list as $v)
                                <option value="{{$v->id}}" @if($info->fid==$v->id) selected @endif>{{$v->name}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="display">
                            <option @if($info->display=='1') selected @endif value="1">显示</option>
                            <option @if($info->display=='0') selected @endif value="0">隐藏</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="sm" name="order" value="{{$info->order}}">
                    </td>
                </tr>
                <tr>
                    <th></th>
